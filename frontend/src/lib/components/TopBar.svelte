...
>
    ...
    <a href="/settings" class="p-2 cursor-pointer rounded-md hover:bg-gray-200 dark:hover:bg-gray-950" aria-label="Settings">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="h-5 w-5 lucide lucide-settings-icon lucide-settings"
            ><path
