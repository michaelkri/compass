...
def create_ai_analysis(job_description: str, base_dir: Path) -> AnalysisSchema:
    ...
    prompt_template = ChatPromptTemplate.from_messages([
        (
            ...
            "Answers should be relevant for the current date, which is {current_date}."
            ...
            "\n2. **Insight Categories**: Use the categories: 'Match', 'Missing', 'Partial', 'Quick Learn' for the insights_list."
